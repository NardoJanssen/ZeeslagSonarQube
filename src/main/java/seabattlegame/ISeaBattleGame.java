...
public interface ISeaBattleGame {
    ...
    Ship getLastAddedShip();

    ArrayList<Ship> getAllPlayerShips();
    ...
    Ship removeShipPlayer(int playerNr, int posX, int posY);
    ...
    boolean checkIfShotThisSpotAlready(int playerNr, int x, int y);
}
